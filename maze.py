...
class Maze:
    def __init__(
        ...
        self._x1 = x1
        self._y1 = y1
        self._x2 = x1 * cell_size_x * num_cols
        self._y2 = y1 * cell_size_y * num_rows
        self._num_rows = num_rows
        self._num_cols = num_cols
        self._cell_size_x = cell_size_x
        self._cell_size_y = cell_size_y
        self._win = win
        self._entrance_x = self._x1 * self._cell_size_x
        self._entrance_y = self._y1 * self._cell_size_y
        self._exit_x = self._entrance_x + self._cell_size_x * num_cols
        self._exit_y = self._entrance_y + self._cell_size_y * num_rows
        ...
        self._break_walls_r(random.randint(1, num_cols), random.randint(1, num_rows))
